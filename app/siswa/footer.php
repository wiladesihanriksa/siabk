  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y') ?></strong> - <?php echo getSetting($app_settings, 'app_name', 'Sistem Informasi E-Point'); ?> <?php echo getSetting($app_settings, 'app_author', 'MAN 2 Semarang'); ?>
  </footer>
