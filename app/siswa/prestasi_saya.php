...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Riwayat Prestasi Saya
      <small>Riwayat Point Prestasi Saya</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <section class="col-lg-12">
        <div class="box box-primary">
          ...
          <div class="box-header">
            <h3 class="box-title">Riwayat Prestasi Saya</h3>
          </div>
          <div class="box-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  $total = 0;
                  $id_saya = $_SESSION['id'];
                  $data = mysqli_query($koneksi,"SELECT * FROM siswa, prestasi, jurusan, input_prestasi, kelas, ta where ta_id=kelas_ta and jurusan_id=kelas_jurusan and input_prestasi.kelas=kelas_id and input_prestasi.siswa=siswa_id and input_prestasi.prestasi=prestasi_id and siswa_id='$id_saya' order by input_prestasi.id desc");
                  ...
                  <tr>
                    ...
                    <td class="text-center text-bold bg-green"><?php echo $total ?></td>
                  </tr>
                </tbody>
              </table>
            </div>
