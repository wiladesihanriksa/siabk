...
if($kunjungan_id <= 0) {
    header("location:kunjungan_rumah_saya.php?alert=gagal&pesan=ID tidak valid");
    exit();
}
...
if(mysqli_num_rows($result) == 0) {
    header("location:kunjungan_rumah_saya.php?alert=gagal&pesan=Data kunjungan tidak ditemukan");
    exit();
}
...
// Query lampiran foto
$query_lampiran = "SELECT * FROM lampiran_kunjungan WHERE kunjungan_id = '$kunjungan_id' ORDER BY created_at ASC";
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="kunjungan_rumah_saya.php">Kunjungan Rumah</a></li>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-body text-center">
            ...
            <a href="kunjungan_rumah_saya.php" class="btn btn-default">
