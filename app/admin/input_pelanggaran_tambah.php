            ...
            <div class="form-group">
              ...
              <select class="form-control" name="pelanggaran" required="required">
                ...
                while($j = mysqli_fetch_array($pelanggaran)){
                  ?>
                  <option value="<?php echo $j['pelanggaran_id'] ?>"><?php echo $j['pelanggaran_nama'] ?> (<?php echo $j['pelanggaran_point'] ?> Point)</option>
                  <?php 
                }
                ?>
              </select>
