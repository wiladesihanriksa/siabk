        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['ta_filter']) && !empty($_GET['ta_filter'])){
              ...
              // Hitung siswa yang punya kelas di tahun ajaran aktif saja
              $count_query = "SELECT COUNT(DISTINCT s.siswa_id) as total 
                             FROM siswa s 
                             JOIN jurusan j ON s.siswa_jurusan = j.jurusan_id
                             JOIN kelas_siswa ks ON s.siswa_id = ks.ks_siswa 
                             ...
                             WHERE t.ta_status = 1 AND s.siswa_status = 'aktif' $search_condition";
            }
            ...
            <div class="alert alert-info">
              ...
              <?php else: 
                ...
                $ta_aktif = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM ta WHERE ta_status = 1 LIMIT 1"));
              ?>
                Menampilkan <strong><?php echo $start_data; ?>-<?php echo $end_data; ?></strong> dari <strong><?php echo $total_data; ?></strong> siswa (tahun ajaran aktif: <strong><?php echo isset($ta_aktif['ta_nama']) ? $ta_aktif['ta_nama'] : 'Tidak ada'; ?></strong>)
              <?php endif; ?>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  if(isset($_GET['ta_filter']) && !empty($_GET['ta_filter'])){
                    ...
                    // Tampilkan siswa yang punya kelas di tahun ajaran aktif saja
                    $query = "SELECT DISTINCT s.*, j.jurusan_nama, k.kelas_nama 
                             FROM siswa s 
                             JOIN jurusan j ON s.siswa_jurusan = j.jurusan_id 
                             JOIN kelas_siswa ks ON s.siswa_id = ks.ks_siswa 
