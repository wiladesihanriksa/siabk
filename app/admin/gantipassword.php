...
// Check if user is logged in and is administrator or guru_bk
if(!isset($_SESSION['level']) || ($_SESSION['level'] != "administrator" && $_SESSION['level'] != "guru_bk")){
    header("location:../index.php?alert=access_denied&pesan=Anda tidak memiliki akses untuk mengganti password");
    exit();
}
