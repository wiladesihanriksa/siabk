<?php
/**
 * Download Template Excel untuk Import Data Prestasi
...
// Ambil ID prestasi pertama untuk contoh
$prestasi_contoh_id = !empty($prestasi_data) ? $prestasi_data[0]['prestasi_id'] : 1;
...
$sharedStringsArray[] = 'ID Prestasi';
...
foreach($siswa_data as $siswa) {
    ...
    $sharedStringsArray[] = (string)$prestasi_contoh_id;
    $sharedStringsArray[] = $tanggal_contoh;
}

// Header sheet 2
$sharedStringsArray[] = 'ID Prestasi';
$sharedStringsArray[] = 'Nama Prestasi';
$sharedStringsArray[] = 'Point';

// Data prestasi
foreach($prestasi_data as $prestasi) {
    $sharedStringsArray[] = (string)$prestasi['prestasi_id'];
    $sharedStringsArray[] = $prestasi['prestasi_nama'];
    $sharedStringsArray[] = (string)$prestasi['prestasi_point'];
}
...
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
    ...
    <sheet name="Referensi Prestasi" sheetId="2" r:id="rId2"/>
  </sheets>
</workbook>';
...
foreach($siswa_data as $siswa) {
    ...
    $worksheet1 .= '<c r="E' . $row . '" t="s"><v>' . $stringIndex . '</v></c>'; $stringIndex++; // ID Prestasi
...
// Worksheet 2: Referensi Prestasi
$maxRow2 = 1 + count($prestasi_data);
