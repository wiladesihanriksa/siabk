...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-home"></i> Tambah Kunjungan Rumah
      <small>Catatan Home Visit Baru</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="kunjungan_rumah.php">Kunjungan Rumah</a></li>
      <li class="active">Tambah Kunjungan</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <i class="fa fa-plus"></i> Form Kunjungan Rumah Baru
            </h3>
          ...
          <form action="kunjungan_rumah_act.php" method="post" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="siswa_id" class="form-control select2" required>
                      ...
                      <?php
                      $query_siswa = "SELECT DISTINCT s.*, j.jurusan_nama, k.kelas_nama 
                                     FROM siswa s 
                      ...
                      while($siswa = mysqli_fetch_assoc($result_siswa)) {
                        echo "<option value='" . $siswa['siswa_id'] . "'>" . 
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="alamat_kunjungan" class="form-control" rows="3" 
                              placeholder="Masukkan alamat lengkap kunjungan..." required></textarea>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="petugas_bk_id" class="form-control" required>
                      ...
                      while($petugas = mysqli_fetch_assoc($result_petugas)) {
                        $selected = ($petugas['user_id'] == $_SESSION['user_id']) ? 'selected' : '';
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="tujuan_kunjungan" class="form-control" rows="2" 
                              placeholder="Contoh: Konfirmasi masalah absensi, Diskusi perkembangan belajar siswa dengan orang tua..." required></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="pihak_ditemui" class="form-control" rows="2" 
                              placeholder="Contoh: Ibu kandung dan siswa ybs, Ayah dan Kakak..." required></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="hasil_observasi" class="form-control" rows="2" 
                              placeholder="Deskripsi objektif mengenai kondisi rumah dan lingkungan sekitar..." required></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="ringkasan_wawancara" class="form-control" rows="4" 
                              placeholder="Poin-poin penting dari percakapan dengan keluarga..." required></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="kesimpulan" class="form-control" rows="3" 
                              placeholder="Kesimpulan umum dari hasil kunjungan..." required></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="rekomendasi_tindak_lanjut" class="form-control" rows="3" 
                              placeholder="Langkah yang perlu diambil setelah kunjungan..." required></textarea>
                  </div>
                </div>
              </div>
